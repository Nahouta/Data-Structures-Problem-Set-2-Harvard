...
public class SortCount {
    ...
    /*Implementation of the swapSort algorithm using the SortCount.compare() and SortCount.swap() methods */

    public static void swapSort(int [] arr) {
        /*Checking for the trivial cases */
        if (arr == null) {
        ...
        for (int i = 0; i < arr.length - 1; i++) {
            for (int j = i + 1; j < arr.length; j++) {
                if (SortCount.compare( arr[i] > arr[j])) {
                    SortCount.swap(arr, i, j);
                }
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        System.out.print("How many iterations of tests? ");
        numTests = in.nextInt();
        System.out.println();
        in.close();
        ...
        System.out.println("\nn = " + numItems + "; Type = " + arrayType + "; Number of Tests = " + numTests);
        System.out.println("Average Number of Comparisons for " + numTests + " Tests is: " + (long)(totalComps/numTests));
        System.out.println("Average Number of Moves for " + numTests + " Tests is: " + (long)(totalMoves/numTests));
    }
}
